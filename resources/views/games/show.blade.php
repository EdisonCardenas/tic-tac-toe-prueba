...
@section('content')
    ...
    <div class="row">
        <div class="col-sm text-center pb-3">
            ...
            {!! Form::hidden('id juego', $game->id) !!}
            {!! Form::submit(__('Juega de nuevo'), ['class' => 'btn btn-primary']) !!}
            {!! Form::close() !!}

        </div>
        <div class="col-sm text-center pb-3">

            {{ link_to_route('games.create', __('Nuevo juego'), [], ['class' => 'btn btn-success']) }}

        </div>
        <div class="col-sm text-center pb-3">

            {{ link_to_route('games.index', __('Registros'), [], ['class' => 'btn btn-info']) }}
